...
module.exports = {
    compileSource: function (source, options) {
        return this._wrap([compiler.compile(source, options.filename)], [options.filename], options);
    },

    compileFile: function (filename, options) {
        return this.compileSource(this._readFile(filename), options);
    },
