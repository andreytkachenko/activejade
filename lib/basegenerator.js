...
var BaseGenerator = (function() {
    ...
    function BaseGenerator(options) {
        ...
        this.__decorators = options.decorators || {};
    ...
    BaseGenerator.prototype = {
        ...
        forin: function (scope, parent, children, expr, value, key, deps) {
            var expr_f = this.__unwrap(expr),
                self = this;
        ...
        ifelse: function (scope, parent, children, cond, deps) {
            ...
            original = update_children(self.__unwrap(cond));
        ...
        mixincall: function (scope, parent, children, name, args, attrs, deps) {
            if (!this.__mixins[name]) {
