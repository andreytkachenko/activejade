...
module.exports = (function () {
    ...
    var walkNode = function (node, document, onchange) {
        ...
        node.listen(function () {
            ...
            if (closest.type === 2) {
                update_attributes(closest.$, closest);
                update_children(closest.$, flatten(walkNodes(closest.children, document, onchange)));
            } else {
        ...
        switch (node.type) {
            ...
            case 1:
                ...
                update_children(el, flatten(walkNodes(node.children, document, onchange)));
