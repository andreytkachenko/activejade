...
},"div",null,[],[]]);var n_7=d.next("tag",[s,function(){return n_0;},function(s){
...
},"a",function(s,c){return d.util.merge_attrs([{"href": d.__p(d.__p(s.h))}]);},[],["h"]]);return [n_9];
},function(s,c){return d.__p(s.test);},"x","h",true,["test"]]);return [n_8];
},"div",null,[],[]]);;n_0=d.generate([n_1,n_7]);return n_0;}}]