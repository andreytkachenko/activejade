...
var statements = require('../tests/compiled/test_cal');
...
var res = template.get( statements.FILE_NAME )($scope, generator);
...
var el = generator.generate(res);
// printTree(el);
var eee = domGenerator(el, window.document);
setElements(window.document.body, eee);
console.log(serializeDocument(doc));
